...
HELPDESK = ENV_TOKENS.get("HELPDESK", '')
HELPDESK_URL = ENV_TOKENS.get("HELPDESK_URL", ENV_TOKENS.get('ZENDESK_URL', ''))
ZENDESK_CUSTOM_FIELDS = ENV_TOKENS.get('ZENDESK_CUSTOM_FIELDS', ZENDESK_CUSTOM_FIELDS)
HELPDESK_SUPPORT_BACKEND = ENV_TOKENS.get('HELPDESK_SUPPORT_BACKEND', HELPDESK_SUPPORT_BACKEND)
...
# Helpdesk
HELPDESK_USER = AUTH_TOKENS.get("HELPDESK_USER", "")
HELPDESK_API_KEY = AUTH_TOKENS.get("HELPDESK_API_KEY", "")
...
if FEATURES.get('ENABLE_THIRD_PARTY_AUTH'):
    ...
    SOCIAL_AUTH_DISCONNECT_PIPELINE = ENV_TOKENS.get('SOCIAL_AUTH_DISCONNECT_PIPELINE', {})
    
    SOCIAL_AUTH_DISCONNECT_REDIRECT_URL = ENV_TOKENS.get('SOCIAL_AUTH_DISCONNECT_REDIRECT_URL', '')
    ...
    OAUTH_EXTRA_LOGOUT_URL = ENV_TOKENS.get('OAUTH_EXTRA_LOGOUT_URL', None)
